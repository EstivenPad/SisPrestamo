								...
								<li aria-haspopup="true" data-menu-toggle="hover" class="menu-item menu-item-submenu">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        <span class="svg-icon menu-icon">
                                            ...
                                            <path d="M20,22 C21.6568542,22 23,20.6568542 23,19 C23,17.8954305 22,16.2287638 20,14 C18,16.2287638 17,17.8954305 17,19 C17,20.6568542 18.3431458,22 20,22 Z" fill="#000000" opacity="0.3"></path></g></svg>
                                        </span> 
                                        <span class="menu-text">Configuracion</span>
                                         <i class="menu-arrow"></i></a> 
                                         <div kt-hidden-height="80" class="menu-submenu" style="display: none; overflow: hidden;">
                                             ...
                                             <ul class="menu-subnav">
                                                ...
                                                <li aria-haspopup="true" class="menu-item">
                                                    ...
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                     <span class="menu-text">Permiso</span></router-link>
                                                       </template>
                                                </li>
                                           </ul>
                                        </div>
